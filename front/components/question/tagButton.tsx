...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 tracking-wide break-keep text-pretty disabled:pointer-events-none disabled:opacity-50 disabled:text-slate-500 disabled:border-b-[0px] disabled:text-slate-100 disabled:border-slate-200 disabled:shadow-inner",
  {
    variants: {
      variant: {
        default:
...
const TagButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
...
TagButton.displayName = "Button";

export { TagButton, buttonVariants };
