...
const stageVariants = cva(
  "flex block items-center justify-center whitespace-wrap border-2 border-t-0 border-b-[6px]  rounded-[50%] text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        default:
          "bg-white text-black border-slate-200 active:border-b-2 hover:bg-slate-100 text-slate-500",
        primary:
          "bg-green-400 text-primary-foreground border-green-500 hover:bg-green-400/60 active:border-b-0 active:bg-green-300/60 focus:ring-4 focus:ring-green-700",
        primaryOutline: "border-white text-sky-500 hover:bg-slate-100",
        secondary:
          "bg-sky-400 text-primary-foreground border-sky-500 hover:bg-sky-400/60 active:border-b-0 active:bg-sky-400/60 focus:ring-4 focus:ring-violet-600",
        ...
        gray: "bg-gray-300 text-white hover:bg-gray-300/80 border-gray-400 border-b-[6px] active:border-b-0",
      },
      size: {
